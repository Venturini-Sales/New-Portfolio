            ...
            <div className='centralContent'>
                ...
                <Slider {...settings}>
                    ...
                    <img className='projectImage' src={Aerowave} alt="" />
                        ...
                        <div className='info'>{textIdioms.projectText[`${language}1`]}</div>
                        
                        <div className='linksArea'>
                            <a target='blank' href="https://github.com/Venturini-Sales/AeroWave">  
                            <button className='button'>{miscellaneousIdioms.buttons[`${language}1`]}</button>
                            </a>
                            <a target='blank' href="https://aerowave-zeta.vercel.app/">
                            <button className='button'>{miscellaneousIdioms.buttons[`${language}2`]}</button> 
                            </a>
                        </div>
                    ...
                    <img className='projectImage' src={Bmi} alt="" />
                        ...
                        <div className='info'>{textIdioms.projectText[`${language}2`]}</div>
                    ...
                    <img className='projectImage' src={Pokedex} alt="" />
                        ...
                        <div className='info'>{textIdioms.projectText[`${language}3`]}</div>
