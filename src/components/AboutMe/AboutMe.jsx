    ...
    <div className="aboutMe">
          ...
          >
            <div className="languages">
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#61DAFB" }}>
                  React
                </div>
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#E44D26" }}>
                  Html
                </div>
                <div className="languageIcon">
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#1572B6" }}>
                  Css
                </div>
                <div className="languageIcon">
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#F0DB4F" }}>
                  Javascript
                </div>
                <div className="languageIcon">
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#007acc" }}>
                  Typescript
                </div>
                <div className="languageIcon">
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#38bdf8" }}>
                  Tailwind Css
                </div>
                <div className="languageIcon">
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#CB6699" }}>
                  Sass
                </div>
                <div className="languageIcon">
              ...
              <div className="languageArea">
                <div className="tip" style={{ backgroundColor: "#00618A" }}>
                  MySQL
                </div>
                <div className="languageIcon">
      ...
      <div className="secondaryContent">
        <ParallaxText baseVelocity={-5}>
          {miscellaneousIdioms.parallaxText[`${language}1`]}
        </ParallaxText>
        <ParallaxText baseVelocity={5}>
          {miscellaneousIdioms.parallaxText[`${language}2`]}
        </ParallaxText>
      </div>
    </div>
  );
